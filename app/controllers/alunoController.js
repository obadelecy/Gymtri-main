...
console.log(bcrypt.hashSync('teste123@', salt))
const alunoController = {
  ...
  logar: (req, res) => {
    ...
    if (req.session.autenticado.autenticado != null) {
      if (req.session.autenticado.tipo == 'aluno') {
        res.render('pages/interfaces/interfaceUsuario')
      } else if (req.session.autenticado.tipo == 'academia') {
        res.render('pages/interfaces/interfaceAcademia')
      } else if (req.session.autenticado.tipo == 'profissional') {
